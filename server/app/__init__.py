...
from app.resource.r_user import UserAuth, UserRegistration, CheckSession, RegisteredVillages, RegisteredBrgyStreets, PostsData, EventsData
from app.resource.r_partial_admin import UserVerification, UnverifiedUserData, PostManagement 
